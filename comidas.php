    ...
    <div class="carousel-inner">
	  ...
	  <img src="images/foto6.jpg" alt="">
        ...
        <div class="carousel-caption" style="padding: 100px;">
		  ...
		  <h1 class="p6 fon2" style="font-family: verdana;  font-size: 35px;"> Compre delícias para qualquer ocasiÃ£o!</h1>
	  ...
	  <img src="images/foto5.jpg" alt="">
		...
		<div class="topnav" id="myTopnav">
					  ...
					  <a href="cadastro.html">Cadastrar-se</a>
					   <a href="orcamento.php">OrÃ§amento</a>
		...
		<h2 style="text-align: center; font-family: Arial; color: #1C1C1C" class="p3">Encontre delÃ­cias para qualquer ocasiÃ£o!</h2>
